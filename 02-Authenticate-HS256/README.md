...
If you download this sample from the Hapi API quickstart page, a `.env` file will come pre-populated with your API identifier, Auth0 domain, and HS256 signing secret. If you clone the repo from GitHub, you will need to rename `.env.example` to `.env` and provide these values manually.
